...
exports.SimpleFusionResolver = void 0;
const ethers_1 = require("ethers");
const axios_1 = __importDefault(require("axios"));
const logger_1 = require("../utils/logger");
const logger = (0, logger_1.createLogger)('SimpleFusionResolver');
...
class SimpleFusionResolver {
    ...
    // 1inch API endpoints
    RELAYER_API = 'https://api.1inch.dev/fusion-relayer';
    constructor(provider, privateKey, resolverContractAddress, chainId = 1) {
        this.resolverContractAddress = resolverContractAddress;
        this.chainId = chainId;
        this.provider = provider;
        this.wallet = new ethers_1.ethers.Wallet(privateKey, provider);
        this.resolverContract = new ethers_1.ethers.Contract(resolverContractAddress, RESOLVER_ABI, this.wallet);
    ...
    async fetchPendingOrders() {
        ...
        const response = await axios_1.default.get(`${this.RELAYER_API}/v1.0/${this.chainId}/orders/pending`, {
            headers: {
    ...
    async fillOrder(order) {
        ...
        try {
            ...
            const tx = await this.resolverContract.fillOrder(orderStruct, order.signature, "0x", // empty interaction
    ...
    async checkInventory(tokenAddress, requiredAmount) {
        try {
    ...
    async getInventoryBalances(tokens) {
        const balances = {};
...
exports.SimpleFusionResolver = SimpleFusionResolver;
//# sourceMappingURL=SimpleFusionResolver.js.map